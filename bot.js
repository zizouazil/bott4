...
const prefix = '*';
const discord_token = "NDE0NDAzNzc4NDY1MjM0OTU0.DX2lqg.wsc26uXBdQBtgu7_nNu7oEOv-KY";
client.login(discord_token);
client.on('ready', function() {
	console.log(`i am ready ${client.user.username}`);
    client.user.setGame(prefix + 'help || cute');
});
/*
////////////////////////\\\\\\\\\\\\\\\\\\\\\\\\\
////////////////////////\\\\\\\\\\\\\\\\\\\\\\\\\
				...
				fetchVideoInfo(id, function(err, videoInfo) {
					...
					let play_info = new Discord.RichEmbed()
						...
						.addField('||**__تم تشغيل __**', `**${videoInfo.title}
							  **`)
						.setColor("RANDOM")
                        .addField(`__من قبل__: ${message.author.username}`, `**__cute__**`)
						.setThumbnail(videoInfo.thumbnailUrl)
